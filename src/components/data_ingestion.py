...
class DataIngestion:       # It calls the data from the source and then splits it into train and test data and saves it in the artifacts folder i
    def __init__(self):
        self.ingestion_config = DataIngestionConfig()
        
    def initiate_data_ingestion(self):    # Read data from database or from csv file
